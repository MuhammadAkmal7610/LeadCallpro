...
export default function UsersManagement() {
    ...
    const users = [
        ...
        { id: 6, name: 'Esha Aftab', email: 'eshaftab@salesrep.in', initials: 'EA', color: 'bg-teal-100 text-teal-600', role: 'Caller', roleType: 'caller', status: 'Deleted', permission: 'Default Caller Permissions', expiry: '2 Feb 2026', license: 'Whatsapp Chat Sync' },
    ];
