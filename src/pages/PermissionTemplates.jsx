...
export default function PermissionTemplates() {
    ...
    const templates = [
        { id: 1, name: 'Default Caller Permissions', assigned: 20, lastModified: '2M ago', type: 'caller' },
        { id: 2, name: 'Default Manager Permissions', assigned: 0, lastModified: '2M ago', type: 'manager' },
        { id: 3, name: 'Default Marketing Permissions', assigned: 0, lastModified: '5M ago', type: 'marketing' },
        { id: 4, name: 'Default Root Permissions', assigned: 1, lastModified: '5M ago', type: 'root' },
        { id: 5, name: 'Default Admin Permissions', assigned: 0, lastModified: '5M ago', type: 'admin' },
    ];

    const defaultTemplates = [
        { id: 1, role: 'Caller', template: 'Default Caller Permissions', assigned: 20, lastModified: '2M ago', type: 'caller' },
        { id: 2, role: 'Manager', template: 'Default Manager Permissions', assigned: 0, lastModified: '2M ago', type: 'manager' },
        { id: 3, role: 'Marketing', template: 'Default Marketing Permissions', assigned: 0, lastModified: '5M ago', type: 'marketing' },
        { id: 4, role: 'Root', template: 'Default Root Permissions', assigned: 1, lastModified: '5M ago', type: 'root' },
        { id: 5, role: 'Admin', template: 'Default Admin Permissions', assigned: 0, lastModified: '5M ago', type: 'admin' },
    ];
                                            ...
                                            templates.map((template) => (
                                                <tr key={template.id} className="hover:bg-gray-50/80 transition-colors">
                                                    ...
                                                    <td className="px-6 py-4 whitespace-nowrap text-center">
                                                        <span className="text-sm text-gray-600 font-medium">{template.assigned}</span>
                                                    </td>
                                                ...
                                                <tr key={template.id} className="hover:bg-gray-50/80 transition-colors">
                                                    <td className="px-6 py-4 whitespace-nowrap">
                                                        <div className="flex items-center gap-3">
                                                            ...
                                                            <span className="text-sm font-medium text-gray-900">{template.role}</span>
                                                        </div>
                                                    </td>
                                                    <td className="px-6 py-4 whitespace-nowrap">
                                                        <span className="text-sm text-gray-700">{template.template}</span>
                                                    </td>
                                                    <td className="px-6 py-4 whitespace-nowrap text-center">
                                                        <span className="text-sm text-gray-600 font-medium">{template.assigned}</span>
                                                    </td>
