                    ...
                    <div className="max-w-7xl mx-auto space-y-4">
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                                ...
                                <button className="text-[#08A698] hover:bg-teal-50 p-1 rounded-full transition-colors">
                            ...
                            <div className="flex items-center gap-3 relative">
                                ...
                                <button
                                    ...
                                    className="bg-[#08A698] hover:bg-[#068f82] text-white px-4 py-2 rounded-lg text-sm font-medium flex items-center gap-2 transition-colors relative z-0"
                                >
                        ...
                        <div className="flex flex-wrap items-center justify-between gap-4 py-2">
                            ...
                            <div className="flex items-center gap-4">
                                <span className="text-xs text-gray-500 font-medium">0 matching tasks found</span>
                            </div>
                        </div>
