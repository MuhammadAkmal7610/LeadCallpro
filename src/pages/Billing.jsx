                                ...
                                <div className="bg-white rounded-2xl shadow-sm border border-gray-200 h-full flex flex-col">
                                    ...
                                    <div className="p-6 border-b border-gray-100">
                                        ...
                                        <div className="bg-gray-50 rounded-xl p-4 flex items-start justify-between group hover:bg-gray-100/80 transition-colors">
                                            <div>
                                                <div className="font-bold text-gray-900 text-sm mb-0.5">Eon Holding</div>
                                                <div className="text-sm text-gray-500">(eonholdings.pk@gmail.com)</div>
                                            </div>
                                    ...
                                    <div className="flex-1 flex flex-col items-center justify-center p-12 text-center min-h-[400px]">
                                        <div className="relative mb-6">
                                            ...
                                            {/* Cart Lines Decoration */}
                                            <div className="absolute top-0 right-0 w-3 h-3 bg-[#08A698] rounded-full animate-pulse"></div>
                                        </div>
                                        <h3 className="text-lg font-bold text-gray-600 mb-2">No items in cart!</h3>
