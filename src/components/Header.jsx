                    ...
                    <div className="relative group">
                        ...
                        <div className="absolute top-full right-0 mt-2 w-80 bg-white rounded-xl shadow-xl border border-gray-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible z-50 overflow-hidden ring-1 ring-black/5 transition-all duration-200 ease-in-out delay-200 group-hover:delay-75">
                            ...
                            <div className="px-4 py-3 border-b border-gray-100 flex items-center justify-between bg-gray-50/50">
                                ...
                                <button className="text-[10px] font-bold text-[#08A698] hover:text-[#068f82] uppercase tracking-wide">
                                    Mark all as read
                                </button>
                            </div>
                            ...
                            <div className="max-h-[320px] overflow-y-auto">
                                {/* Item 1 - Unread */}
                                <div className="px-4 py-3 hover:bg-gray-50 transition-colors cursor-pointer border-b border-gray-50 relative group/item">
                                    <div className="flex gap-3">
                                        <div className="shrink-0 mt-1">
                                            <div className="w-8 h-8 rounded-full bg-[#08A698]/10 flex items-center justify-center text-[#08A698]">
                                                <UsersIcon className="w-4 h-4" />
                                            </div>
                                        </div>
                                        <div className="flex-1 space-y-1">
                                            <p className="text-xs text-gray-600">
                                                <span className="font-semibold text-gray-900">Esha Aftab</span> assigned a new lead to you.
                                            </p>
                                            <p className="text-[10px] text-gray-400 font-medium">2 min ago</p>
                                        </div>
                                ...
                                <div className="px-4 py-3 hover:bg-gray-50 transition-colors cursor-pointer border-b border-gray-50 relative group/item">
                                    <div className="flex gap-3">
                                        ...
                                        <div className="flex-1 space-y-1">
                                            <p className="text-xs text-gray-600">
                                                Call reminder for <span className="font-semibold text-gray-900">Tech Corp</span> scheduled in 15 mins.
                                            </p>
                                            <p className="text-[10px] text-gray-400 font-medium">1 hour ago</p>
                                        </div>
                                        <div className="shrink-0 self-center">
                                            <div className="w-1.5 h-1.5 rounded-full bg-[#08A698]"></div>
                                        </div>
                                ...
                                {/* Item 3 - Read */}
                                <div className="px-4 py-3 hover:bg-gray-50 transition-colors cursor-pointer relative group/item">
                                    <div className="flex gap-3">
                                        <div className="shrink-0 mt-1">
                                        ...
                                        <div className="flex-1 space-y-1">
                                            <p className="text-xs text-gray-600">
                                                Subscription renewed successfully for <span className="font-semibold text-gray-900">Pro Plan</span>.
                                            </p>
